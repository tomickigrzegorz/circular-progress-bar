...
colorSlice | string | `'#00a1ff'` | | Progress layer color and background ["#ffff00","brown"](#colors-link)
colorCircle | string | `'#00a1ff'` | | Bottom circle color Font ["#ffff00","brown"](#colors-link)
...
fontColor | string | `'#365b74'` |  | Font color ["#ffff00","brown"](#colors-link)
lineargradient | array |  |  | Array of colors "lineargradient": ["#ffff00","brown"](#colors-link)
