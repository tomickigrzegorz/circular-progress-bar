var CircularProgressBar=function(){function g(a){this.pieName=a=a.pieName;this.pieElement=document.querySelectorAll("."+a);this.b="http://www.w3.org/2000/svg";this.g="http://www.w3.org/2000/xmlns/";this.l(this.pieElement)}g.prototype.l=function(a){var c=this;if("IntersectionObserver"in window)for(var b=new IntersectionObserver(function(f){return f.forEach(function(e){if(.75<e.intersectionRatio){for(var h=0;h<a.length;h++)a[h].getAttribute("data-pie")===e.target.getAttribute("data-pie")&&c.f(e.target,
h);b.unobserve(e.target)}})},{root:null,rootMargin:"0px",threshold:0}),d=0;d<a.length;d++)b.observe(a[d]);else for(d=0;d<a.length;d++)this.f(a[d],d)};g.prototype.i=function(a){a=a.substring(1,7);return parseInt(a.substring(0,2),16)+", "+parseInt(a.substring(2,4),16)+", "+parseInt(a.substring(4,6),16)};g.prototype.h=function(a){var c=this,b=document.querySelector("."+this.pieName+"-circle-"+this.index),d=this.strokeWidth,f=this.end,e=this.time,h=this.round,p=this.percent,l=this.number,m=this.index;
l&&a.appendChild(this.m());for(a={a:0};a.a<=f;a={a:a.a},a.a++)setTimeout(function(k){return function(){if(!(k.a>p)){l&&c.o(k.a,m);var n=2.64*k.a;b.setAttribute("style","fill: transparent; stroke-width: "+d+"; stroke-dashoffset: 66; stroke-dasharray: "+n+" "+(f-n)+"; "+h)}}}(a),a.a*e);b.setAttribute("stroke",this.lineargradient?"url(#linear)":this.colorSlice);this.pieElement[m].setAttribute("style","width: "+this.size+"px; height: "+this.size+"px;  position: relative; "+(this.colorCircle?"":"border-radius: 50%; box-shadow: inset 0px 0px "+
